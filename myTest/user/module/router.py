...
@user_router.post(f"/{TOKEN_URL}", tags=["Authentication"])
...
@user_router.post(f"/logout", tags=["Authentication"], status_code=status.HTTP_200_OK)
...
@user_router.get("/users/me", tags=["Users"], response_model=UserInfo)
...
@user_router.post("/users/promote/{username}", tags=["Users"], response_model=UserInfo)
...
@user_router.delete("/users/demote/{username}", tags=["Users"], response_model=UserInfo)
...
@user_router.post("/users/privilege/add", tags=["Users"], response_model=UserInfo)
...
@user_router.post("/users/privilege/remove", tags=["Users"], response_model=UserInfo)
...
@user_router.delete("/users/delete/{username}", tags=["Users"], response_model=UserInfo)
...
@user_router.get("/users/all", tags=["Users"], response_model=list[UserInfo])
